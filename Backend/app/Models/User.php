...
class User extends Authenticatable
{
    ...
    public function organizationBelongsTo()
    {
    ...
    {
        return $this->belongsToMany(OrganizationRole::class, 'organization_user_roles');
    }
    ...
    public function getImageUrlAttribute()
    {
        if ($this->image)
        {
            // Fix: Add storage/ prefix for public storage

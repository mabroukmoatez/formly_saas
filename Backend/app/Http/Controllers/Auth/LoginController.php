    ...
    protected function showLoginForm(Request $request)
    {
        ...
        if ($request->has('org')) {
            ...
            if ($organization) {
                ...
                // Use default Formly logo if organization doesn't have one
                $logoUrl = $organization->organization_logo ? 
                    asset($organization->organization_logo) : 
                    asset(getImageFile(get_option('app_logo')));
                view()->share('organization_logo_url', $logoUrl);
                ...
                $data['pageTitle'] = $organization->organization_name . ' - ' . __('Login');
            }
        }
        ...
        */
        if (Auth::attempt($credentials)) {
            ...
            if (Auth::user()->is_admin())
            {
                ...
                // Redirect organization users directly to organization panel

    ...
    public function index()
    {
        if (file_exists(storage_path('installed'))) {
            ...
            if($data['home']->faq_area == 1){
                $data['faqs'] = FaqQuestion::take(6)->get();
            } else {
                $data['faqs'] = collect();
            }
            ...
            if($data['home']->consultation_area == 1){
                ...
                $data['consultationInstructors'] = collect();
            }
            ...
            // Initialize testimonials as empty collection for now
            ...
            return view('frontend.home.modern-home', $data);
        } else {

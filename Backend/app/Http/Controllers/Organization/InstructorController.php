...
class InstructorController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['instructors'] = Instructor::query()
            ->with('user')
            ->where('organization_id', (auth()->user()->organization ?? auth()->user()->organizationBelongsTo)->id)
    ...
    public function store(Request $request)
    {
        ...
        $instructor_data = [
            ...
            'organization_id' => (auth()->user()->organization ?? auth()->user()->organizationBelongsTo)->id
        ];
    ...
    public function edit($uuid)
    {
        ...
        $data['instructor'] = Instructor::where('organization_id', $organization->id)->where('uuid', $uuid)->firstOrFail();
    ...
    public function status(Request $request)
    {
        ...
        // Get organization - either user owns it or belongs to it
        $organization = auth()->user()->organization ?? auth()->user()->organizationBelongsTo;
        $instructor = Instructor::where('organization_id', $organization->id)->findOrFail($request->id);

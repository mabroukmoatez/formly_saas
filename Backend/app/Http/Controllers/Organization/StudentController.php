...
class StudentController extends Controller
{
    ...
    public function view($uuid)
    {
        ...
        $data['student'] = Student::where('organization_id', $organization->id)->where('uuid', $uuid)->firstOrfail();
    ...
    public function status(Request $request)
    {
        ...
        // Get organization - either user owns it or belongs to it
        $organization = auth()->user()->organization ?? auth()->user()->organizationBelongsTo;
        $student = Student::where('organization_id', $organization->id)->findOrFail($request->id);
        if (is_null($student)) {

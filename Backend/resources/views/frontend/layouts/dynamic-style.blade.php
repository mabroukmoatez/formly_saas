<style>
    ...
    [data-theme="dark"] {
        ...
        --body-font-color: #e5e7eb;
        --navbar-bg-color: #1f2937;
        --border-color: rgba(255, 255, 255, 0.1);
        --border-color2: rgba(255, 255, 255, 0.15);
    }

    /* Dark mode navbar icon styling */
    [data-theme="dark"] .menu-round-btn > a {
        background-color: rgba(255, 255, 255, 0.1);
        color: #ffffff !important;
    }

    [data-theme="dark"] .menu-round-btn > a:hover {
        background-color: rgba(255, 255, 255, 0.2);
    }

    [data-theme="dark"] .menu-round-btn > a i {
        color: #ffffff !important;
    }

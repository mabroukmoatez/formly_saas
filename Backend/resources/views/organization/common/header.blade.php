                           ...
                           @endif
                            ...
                            <li class="admin-notification-menu position-relative">
                                <a href="#" class="btn btn-dropdown site-language" id="dropdownNotification" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{{ @$totalOrganizationNotifications }}</span>
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownNotification">
                                    ...
                                    @forelse(@$organizationNotifications as $notification)
                                        <li>
                                                    ...
                                                    <div class="single-notification-item d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <div class="user-img-wrap position-relative radius-50">
                                                                ...
                                                                @else
                                                                    <img src="{{asset('admin/images/icons/user.svg')}}" alt="img" class="radius-50">
                                                                @endif
                                                            </div>
                                                        </div>
                                    ...
                                    @empty
                                        <li>
                                            <p class="text-center p-3 mb-0">{{__('No notifications found')}}</p>
                                        </li>
                                    @endforelse
                                    </ul>
                                    @if(count($organizationNotifications) > 0)
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownUser">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('organization.change-password') }}">

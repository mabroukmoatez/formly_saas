...
CREATE TABLE IF NOT EXISTS `company_documents` (
  ...
  `document_date` DATE NULL COMMENT 'Date du document',
  `reference_number` VARCHAR(100) NULL COMMENT 'Reference number',
  `expiry_date` DATE NULL COMMENT 'Expiration date for contracts',

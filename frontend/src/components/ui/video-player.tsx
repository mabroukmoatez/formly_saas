...
// Simple Video Player for basic use cases
...
export const SimpleVideoPlayer: React.FC<SimpleVideoPlayerProps> = ({
  ...
  return (
    <div className={`relative group bg-black rounded-lg overflow-hidden shadow-lg ${className}`}>
      <video
        src={src}
        poster={poster}
        autoPlay={autoPlay}
      ...
      {!isLoading && !hasError && showPlayButton && !isPlaying && (

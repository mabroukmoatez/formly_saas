        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)] space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option key="reminder" value="reminder">⏰ Rappel</option>
              <option key="document" value="document">📄 Document</option>
              <option key="certificate" value="certificate">🎓 Certificat</option>
              <option key="assignment" value="assignment">📝 Devoir</option>
          ...
          {destType === 'email' && (
            <div>
              ...
              <select value={emailId || ''} onChange={(e) => setEmailId(Number(e.target.value))} className={`w-full mt-1 h-10 px-3 rounded-md border ${isDark ? 'bg-gray-700 border-gray-600 text-white' : ''}`}>
                <option key="placeholder" value="">-- Choisir un template --</option>

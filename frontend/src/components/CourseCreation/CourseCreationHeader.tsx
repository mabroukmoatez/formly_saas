...
const steps = [
  ...
  { number: 5, label: 'Formateur' },
  { number: 6, label: 'Déroulement' },
];

export const CourseCreationHeader: React.FC<CourseCreationHeaderProps> = ({
  currentStep,
  totalSteps,
  onStepClick,
  onAutoSave,
  ...
  const calculateProgress = () => {
    ...
    const totalFields = 12; // title, subtitle, description, category, language, difficulty, price_ht, duration, duration_days, target_audience, prerequisites, tags

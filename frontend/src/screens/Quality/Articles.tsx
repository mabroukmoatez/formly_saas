...
import { Search, Filter, Newspaper, BookOpen, TrendingUp, Eye, Award, Users, GraduationCap, CheckCircle, Building2, Car, Laptop, Loader2 } from 'lucide-react';
...
export const Articles = (): JSX.Element => {
  ...
  return (
    <div className="px-[27px] py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            >
              Centre de ressources et documentation Qualiopi
            </p>
          </div>
        </div>
      </div>
            ...
            {categories.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-sm font-medium ${isDark ? 'text-gray-200' : 'text-gray-700'} [font-family:'Poppins',Helvetica]`}>
                    {category.name}
                  </span>
                </button>
              );
      ...
      {/* Error State */}
      {error && (
        <Card className={`border-2 ${isDark ? 'border-red-700 bg-red-900/20' : 'border-red-200 bg-red-50'} rounded-[18px] mb-6`}>
          <CardContent className="p-6">
            <p className={`${isDark ? 'text-red-300' : 'text-red-600'} [font-family:'Poppins',Helvetica]`}>
              {error}
            </p>
                ...
                return (
                  <Card
                    ...
                    className={`cursor-pointer transition-all hover:shadow-lg border-2 ${
                      isDark ? 'border-gray-700 hover:border-gray-600 bg-gray-800' : 'border-gray-200 hover:border-gray-300 bg-white'
                    }`}
                    onClick={() => {
                      if (article.url) {

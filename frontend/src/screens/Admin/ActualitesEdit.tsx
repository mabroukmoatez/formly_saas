...
// Rich Text Editor Component (même que dans ActualitesCreate)
...
export const ActualitesEdit = ({ newsId }: ActualitesEditProps): JSX.Element => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        success('Succès', 'Actualité modifiée avec succès');
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="rounded-[13px] px-4 py-2 text-red-600 hover:text-red-700 hover:bg-red-50"
            >

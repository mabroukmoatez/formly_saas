import svgPaths from "../imports/svg-vr3sxnfsn7";

interface HumanExpensesPopupProps {
  onClose: () => void;
}
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#26c9b6] text-[18.177px] text-nowrap">
    ...
    <div className="relative shrink-0 w-full" data-name="card-header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center justify-between p-[12.623px] relative w-full">
          <p className="capitalize font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#19294a] text-[11.783px] text-nowrap whitespace-pre">dépenses Humains</p>
          <Frame5 />
        </div>
      </div>
    </div>
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-[119.691px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#26c9b6] text-[18.177px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">890.93 €</p>
      </div>
    </div>
  );
}
...
function Chart() {
  return (
    <div className="content-stretch flex h-[81px] items-end justify-between relative shrink-0 w-[352px]" data-name="Chart">
      <div className="bg-[rgba(38,201,182,0.25)] h-[34px] rounded-[4.039px] shrink-0 w-[20px]" />
      <div className="bg-[rgba(38,201,182,0.25)] h-[71px] rounded-[4.039px] shrink-0 w-[19px]" />
      <div className="bg-[rgba(38,201,182,0.25)] h-[58px] rounded-[4.039px] shrink-0 w-[19px]" />
      <div className="bg-[rgba(38,201,182,0.25)] h-[66px] rounded-[4.039px] shrink-0 w-[19px]" />
      <div className="bg-[rgba(38,201,182,0.25)] h-[53px] rounded-[4.039px] shrink-0 w-[19px]" />
      <div className="bg-[#26c9b6] h-[81px] rounded-[4.039px] shrink-0 w-[20px]" />
...
function ChartGraphic() {
  return (
    <div className="basis-0 box-border content-stretch flex grow items-center min-h-px min-w-px p-[12px] relative rounded-[7px] shrink-0" data-name="chart-graphic">
...
function Card1() {
  return (
    <div className="relative rounded-[11px] self-stretch shrink-0" data-name="card">
      <div className="box-border content-stretch flex flex-col gap-[5.049px] h-full items-start overflow-clip pb-[15px] pt-0 px-[15px] relative rounded-[inherit]">
        <CardHeader1 />
        <ChartGraphic />
      </div>
...
function Frame9() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] h-[28px] items-center relative shrink-0 w-full">
      <ChartGraphic1 />
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#19294a] text-[11.783px] text-nowrap whitespace-pre">Sowftware</p>
    </div>
  );
}
...
function ChartGraphic2() {
  return (
    <div className="bg-[#26c9b6] box-border content-stretch flex h-[28px] items-center p-[12px] relative rounded-[7px] shrink-0" data-name="chart-graphic">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[11.783px] text-nowrap text-white whitespace-pre">330.93 €</p>
    </div>
  );
}
...
function ChartGraphic3() {
  return (
    <div className="bg-[#26c9b6] box-border content-stretch flex h-[28px] items-center p-[12px] relative rounded-[7px] shrink-0" data-name="chart-graphic">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[11.783px] text-nowrap text-white whitespace-pre">310.93 €</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] h-[28px] items-center relative shrink-0 w-full">
      <ChartGraphic3 />
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#19294a] text-[11.783px] text-nowrap whitespace-pre">Forniture</p>
    </div>
  );
}
...
export default function HumanExpensesPopup({ onClose }: HumanExpensesPopupProps) {
  return (

import svgPaths from "../imports/svg-yl66orcb8z";

interface EnvironmentalExpensesPopupProps {
  onClose: () => void;
}
    ...
    <div className="relative shrink-0 w-full" data-name="card-header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center justify-between p-[12.623px] relative w-full">
          <p className="capitalize font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#19294a] text-[11.783px] text-nowrap whitespace-pre">dépenses Environnementaux</p>
          <Frame5 />
        </div>
      </div>
    </div>
...
function Chart() {
  return (
    <div className="content-stretch flex h-[81px] items-end justify-between relative shrink-0 w-[352px]" data-name="Chart">
      <div className="bg-[#eee0ff] h-[34px] rounded-[4.039px] shrink-0 w-[20px]" />
      <div className="bg-[#eee0ff] h-[71px] rounded-[4.039px] shrink-0 w-[19px]" />
      <div className="bg-[#eee0ff] h-[58px] rounded-[4.039px] shrink-0 w-[19px]" />
      <div className="bg-[#eee0ff] h-[66px] rounded-[4.039px] shrink-0 w-[19px]" />
      <div className="bg-[#eee0ff] h-[53px] rounded-[4.039px] shrink-0 w-[19px]" />
      <div className="bg-[#8c2ffe] h-[81px] rounded-[4.039px] shrink-0 w-[20px]" />
...
function ChartGraphic1() {
  return (
    <div className="bg-[#8c2ffe] box-border content-stretch flex h-[28px] items-center p-[12px] relative rounded-[7px] shrink-0" data-name="chart-graphic">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[11.783px] text-nowrap text-white whitespace-pre">370.93 €</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] h-[28px] items-center relative shrink-0 w-full">
      <ChartGraphic1 />
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#19294a] text-[11.783px] text-nowrap whitespace-pre">Paycheck</p>
    </div>
  );
}
...
function ChartGraphic3() {
  return (
    <div className="bg-[#26c9b6] box-border content-stretch flex h-[28px] items-center p-[12px] relative rounded-[7px] shrink-0" data-name="chart-graphic">
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[11.783px] text-nowrap text-white whitespace-pre">250.93 €</p>
    </div>
  );
}
...
export default function EnvironmentalExpensesPopup({ onClose }: EnvironmentalExpensesPopupProps) {
  return (

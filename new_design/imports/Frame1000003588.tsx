import svgPaths from "./svg-ai4nfp2m4r";
  ...
  return (
    <div className="bg-white relative rounded-[18px] size-full">
      ...
      <div className="flex flex-col justify-end size-full">
        <div className="box-border content-stretch flex flex-col gap-[28px] items-start justify-end px-[20px] py-[59px] relative size-full">
          <Frame1 />
          <Frame2 />
        </div>
      </div>
